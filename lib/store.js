...
export const PRODUCTS = [
  ...
  {
    id: "poster-albatros-a1", name: "Albatros A1", category: "LF Poster",
    price: 100000, priceBasis: "unit", unitLabel: "/A1", unitName: "lembar A1", areaPerUnit: 0.5,
    note: "Harga per lembar ukuran A1.", finishing: LF_POSTER_STANDARD_FINISHING
  },
  {
  ...
  {
    id: "poster-luster-a1", name: "Luster A1", category: "LF Poster",
    price: 125000, priceBasis: "unit", unitLabel: "/A1", unitName: "lembar A1", areaPerUnit: 0.5,
    note: "Harga per lembar ukuran A1.", finishing: LF_POSTER_STANDARD_FINISHING
  },
  {
  ...
  {
    id: "poster-backlite-a4", name: "Backlite Film A4", category: "LF Poster",
    price: 100000, priceBasis: "unit", unitLabel: "/A4", unitName: "lembar A4",
    note: "Harga per lembar ukuran A4.", finishing: FIXED_SIZE_CUT_FINISHING
  },
  {
    id: "poster-backlite-a3", name: "Backlite Film A3", category: "LF Poster",
    price: 125000, priceBasis: "unit", unitLabel: "/A3", unitName: "lembar A3",
    note: "Harga per lembar ukuran A3.", finishing: FIXED_SIZE_CUT_FINISHING
  },
  {
    id: "poster-backlite-a2", name: "Backlite Film A2", category: "LF Poster",
    price: 150000, priceBasis: "unit", unitLabel: "/A2", unitName: "lembar A2",
    note: "Harga per lembar ukuran A2.", finishing: FIXED_SIZE_CUT_FINISHING
  },
  {
    id: "poster-backlite-a1", name: "Backlite Film A1", category: "LF Poster",
    price: 175000, priceBasis: "unit", unitLabel: "/A1", unitName: "lembar A1",
    note: "Harga per lembar ukuran A1.", finishing: FIXED_SIZE_CUT_FINISHING
  },
  {
  ...
  {
    id: "lf-sticker-transparent-a1", name: "LF Sticker Transparant A1", category: "LF Sticker",
    price: 125000, priceBasis: "unit", unitLabel: "/A1", unitName: "lembar A1", areaPerUnit: 0.5,
    note: "Harga per lembar ukuran A1.", finishing: LF_STICKER_STANDARD_FINISHING
  },
  {
  ...
  {
    id: "lf-sticker-white-glossy-a1", name: "LF Sticker White Glossy A1", category: "LF Sticker",
    price: 125000, priceBasis: "unit", unitLabel: "/A1", unitName: "lembar A1", areaPerUnit: 0.5,
    note: "Harga per lembar ukuran A1.", finishing: LF_STICKER_STANDARD_FINISHING
  },
  {
  ...
  {
    id: "lf-sticker-white-matte-a1", name: "LF Sticker White Matte A1", category: "LF Sticker",
    price: 125000, priceBasis: "unit", unitLabel: "/A1", unitName: "lembar A1", areaPerUnit: 0.5,
    note: "Harga per lembar ukuran A1.", finishing: LF_STICKER_STANDARD_FINISHING
  },
  {
...
const PRODUCT_META = {
  ...
  "poster-albatros-a1": { sku: "PRD-ALB-A1", baseCost: 0, saleUnit: "lbr", machineIds: ["mach-eco"], sources: [["mat-albatros", 0.5, 0]] },
  "poster-luster": { sku: "PRD-LUSTER-M2", baseCost: 0, saleUnit: "m²", machineIds: ["mach-eco"], sources: [["mat-luster", 1, 0]] },
  "poster-luster-a1": { sku: "PRD-LUSTER-A1", baseCost: 0, saleUnit: "lbr", machineIds: ["mach-eco"], sources: [["mat-luster", 0.5, 0]] },
  "poster-canvas": { sku: "PRD-CANVAS-M2", baseCost: 0, saleUnit: "m²", machineIds: ["mach-eco"], sources: [["mat-canvas", 1, 0]] },
  "poster-backlite-a4": { sku: "PRD-BLF-A4", baseCost: 0, saleUnit: "lbr", machineIds: ["mach-eco"], sources: [["mat-backlite-film", 0.0625, 0]] },
  "poster-backlite-a3": { sku: "PRD-BLF-A3", baseCost: 0, saleUnit: "lbr", machineIds: ["mach-eco"], sources: [["mat-backlite-film", 0.125, 0]] },
  "poster-backlite-a2": { sku: "PRD-BLF-A2", baseCost: 0, saleUnit: "lbr", machineIds: ["mach-eco"], sources: [["mat-backlite-film", 0.25, 0]] },
  "poster-backlite-a1": { sku: "PRD-BLF-A1", baseCost: 0, saleUnit: "lbr", machineIds: ["mach-eco"], sources: [["mat-backlite-film", 0.5, 0]] },
  "lf-sticker-transparent": { sku: "PRD-STK-TR-M2", baseCost: 0, saleUnit: "m²", machineIds: ["mach-eco"], sources: [["mat-sticker-transparent", 1, 0]] },
  "lf-sticker-transparent-a1": { sku: "PRD-STK-TR-A1", baseCost: 0, saleUnit: "lbr", machineIds: ["mach-eco"], sources: [["mat-sticker-transparent", 0.5, 0]] },
  "lf-sticker-white-glossy": { sku: "PRD-STK-WG-M2", baseCost: 0, saleUnit: "m²", machineIds: ["mach-eco"], sources: [["mat-sticker-white-glossy", 1, 0]] },
  "lf-sticker-white-glossy-a1": { sku: "PRD-STK-WG-A1", baseCost: 0, saleUnit: "lbr", machineIds: ["mach-eco"], sources: [["mat-sticker-white-glossy", 0.5, 0]] },
  "lf-sticker-matte": { sku: "PRD-STK-WM-M2", baseCost: 70000, saleUnit: "m²", machineIds: ["mach-eco"], sources: [["mat-sticker", 1, 7]] },
  "lf-sticker-white-matte-a1": { sku: "PRD-STK-WM-A1", baseCost: 0, saleUnit: "lbr", machineIds: ["mach-eco"], sources: [["mat-sticker", 0.5, 0]] },
  ...
  "x-banner-albatros": { sku: "PRD-XBNR", baseCost: 215000, saleUnit: "set", machineIds: ["mach-eco", "mach-eyelet"], sources: [["mat-albatros", .8, 5], ["mat-xstand", 1, 0], ["mat-eyelet", 4, 0]], wholesale: true, discount: { enabled: true, type: "percent", value: 10, startsAt: "", endsAt: "" } },
